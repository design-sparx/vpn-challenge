	...
	return (
		<div className={classes.wrapper}>
			...
			<div className={classes.inner}>
				...
				<Text size="sm" className={classes.description} mt={20}>
					<FontAwesomeIcon icon={faCheckCircle}/> 30-day money-back guarantee</Text>
			</div>
		</div>
	);
}
